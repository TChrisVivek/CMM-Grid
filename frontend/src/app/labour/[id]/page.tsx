...
import {
  ...
  XCircle, Plus, X, Loader2, FolderKanban, Clock,
  Banknote, TrendingUp, Users, UtensilsCrossed, Car,
...
export default function WorkerDetailPage() {
  ...
  const load = useCallback(async () => {
    ...
    setWorker(found);
    const att: Attendance[] = await aRes.json();
    const pay: Payment[]    = await pRes.json();
    setAttendance(att);
    setPayments(pay);
